            ...
            <div className="pt-52">
                <form className="shadow-md bg-gray-50 dark:bg-gray-900 rounded pt-6 px-8 pb-8 mb-4 w-1/4 m-auto">
                    <div className="mb-4">
                        ...
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="block_title" type="text" name="block_title" placeholder="Block title" onChange={handleInputChange}/>
                    </div>
